...
| --- | --- | --- | --- |
| CodeSaver CLI | [**1.4.2**](https://github.com/vibecraft01/CodeSaver/releases/tag/v1.4.2) | Python 3.9+ | Updated 2026-09-03 |
| CodeSaver Desktop | **1.3.0 (local)** | Python 3.10+ with PyQt5 | Planned 2026-09-04 |
